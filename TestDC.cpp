...
void main(void){
	...
	if(false){
		...
		bottomRight->createEdgeDesc2D(0, 0, 0, base, 1, 0);
		topRight->createEdgeDesc2D(0, 0, 1, base, 1, 0);
		hinge->createEdgeDesc1D(0, base, 0, 1, 5);

		leftTop->createEdgeDesc2D(0, 0, 0, base, 1, 1);
		rightTop->createEdgeDesc2D(0, 1, 0, base, 1, 1);*/
